...
const popularHeader = new Headers();
popularHeader.append("Authorization", ID);

const popularRequestOption = {
    method: "GET",
    headers: popularHeader
}

fetch( popularURL, popularRequestOption )
    .then(res => {
        return res.json();
    })
    .then(result => {
    ...
    pageButton => {
        ...
        pageButton.addEventListener(
            ...
            (e) => {
                ...
                const pagesURL = popularURL + page;
                ...
                fetch( pagesURL, popularRequestOption )
                    .then(res => {
                        return res.json();
                    })
                    .then(result => {
