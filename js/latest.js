...
const latestHeader = new Headers();
latestHeader.append("Authorization", ID);

const latestRequestOption = {
    method: "GET",
    latestURL: latestHeader
}

fetch( latestURL, latestRequestOption )
    .then(res => {
        return res.json();
    })
    .then(result => {
    ...
    pageButton => {
        ...
        pageButton.addEventListener(
            ...
            (e) => {
                ...
                fetch( pagesURL, latestRequestOption )
                    .then(res => {
                        return res.json();
                    })
                    .then(result => {
